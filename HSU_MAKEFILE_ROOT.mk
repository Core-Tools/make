...
# Strip whitespace from directory variables to prevent path issues
GO_DIR := $(strip $(GO_DIR))
PYTHON_DIR := $(strip $(PYTHON_DIR))
...
# Strip whitespace from enable variables to prevent conditional matching issues
ENABLE_GO := $(strip $(ENABLE_GO))
ENABLE_PYTHON := $(strip $(ENABLE_PYTHON))
ENABLE_NUITKA := $(strip $(ENABLE_NUITKA))
...
# Generated prefix configuration (with defaults)
GENERATED_PREFIX ?= generated/

# Strip whitespace from enable variables to prevent conditional matching issues
GENERATED_PREFIX := $(strip $(GENERATED_PREFIX))
INCLUDE_PREFIX := $(strip $(INCLUDE_PREFIX))
